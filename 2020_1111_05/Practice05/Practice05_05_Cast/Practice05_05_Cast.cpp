...
int main()
{
	...
	int iPI1 = PI; // 暗黙的変更で、エラーが出ないが、warning C4244が出る
...
//	int* pNonConst = &iConst; // constでないポインタ変数へのアドレスを渡すこともできない
